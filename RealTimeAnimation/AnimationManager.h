...
void AnimationManager::Load(double animationSpeed, string file_name, string animationName)
{
	...
	AnimationClip* animationtoLoad = new AnimationClip(animationSpeed, file_name, animationName); //I'm not sure this works

	this->m_animationSet[animationName] = animationtoLoad;
}
